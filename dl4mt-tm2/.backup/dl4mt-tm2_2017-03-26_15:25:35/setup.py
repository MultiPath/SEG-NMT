...
def setup_enes_miles():
    ...
    config = {
        ...
        'valid_datasets': [home + '/.dataset/top5k.enes/devset.en.tok',
                           home + '/.dataset/top5k.enes/devset.es.tok',
        ...
        # test phase
        'trans_from': home + '/.dataset/top5k.enes/devset.en.tok',
        'tm_source':  home + '/.dataset/top5k.enes/devset.en.matched.tok',
        'tm_target':  home + '/.dataset/top5k.enes/devset.es.matched.tok',
        'trans_ref':  home + '/.dataset/top5k.enes/devset.es.tok',
        'trans_to':   home + '/.translate/' + name + '.enes.dev.translate',

        # multi-tm test
        'tm_source_full': home + '/.dataset/top5k.fren/train.en.top1.tok',
        'tm_target_full': home + '/.dataset/top5k.fren/train.es.top1.tok',
